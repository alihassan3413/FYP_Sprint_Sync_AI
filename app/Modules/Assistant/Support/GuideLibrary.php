...
final class GuideLibrary
{
    ...
    private const LESSONS = [
        ...
        'board' => [
            ...
            'steps' => [
                'The board shows the project\'s tasks as cards in columns. Drag a card to move it between columns.',
            ...
            'keywords' => ['board', 'kanban', 'column', 'card', 'drag', 'move', 'comment', 'detail', 'live', 'realtime'],
        ],
        'tasks' => [
        ...
        'board-columns' => [
            'title' => 'Setting up board columns',
            'stage' => self::STAGE_DAILY,
            'audience' => self::AUDIENCE_PROJECT_MANAGER,
            'summary' => 'Shaping the board to match how your team actually works.',
            'steps' => [
                'Every project starts with a sensible default set of columns. Rename them to match your process.',
                'Add columns for the stages you really have — a review or QA column, for instance — and reorder them by dragging.',
                'Mark the columns that mean "finished". Completion percentages, sprint health and the archive all key off that flag, and a client who can close tasks can only move work into one.',
                'Deleting a column asks what should happen to the tasks inside it. Work is never silently lost.',
            ],
            'say' => ['What projects do I have?'],
            'where' => 'Projects → open a project → board settings',
            'keywords' => ['board columns', 'column', 'status', 'workflow', 'stage', 'reorder', 'rename', 'done', 'setup', 'customise', 'customize'],
        ],
        'meetings' => [
