...
import type { ApiErrorResponse, AppError, FlashError } from '@/types/errors';
...
function isFlashError(value: unknown): value is FlashError {
    return typeof value === 'object' && value !== null && 'code' in value && 'message' in value && typeof (value as FlashError).code === 'string';
}

function isApiErrorResponse(value: unknown): value is ApiErrorResponse {
    return typeof value === 'object' && value !== null && 'success' in value && (value as ApiErrorResponse).success === false && 'error' in value;
}
