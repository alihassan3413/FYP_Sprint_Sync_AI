...
<template>
    <div class="relative overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950 p-5 text-zinc-100 shadow-sm dark:border-zinc-800">
        <!-- Soft violet glow -->
        <div class="pointer-events-none absolute -top-8 -right-8 size-32 rounded-full bg-violet-500/20 blur-3xl" aria-hidden="true" />

        <div class="relative">
            <div class="flex items-center gap-1.5 text-violet-300">
                <Sparkles class="size-3.5" />
                <span class="text-[10.5px] font-medium tracking-[0.08em] uppercase">
                    {{ eyebrow }}
                </span>
            </div>
