 ...
 * ------------------------------------------------------------------------- */
const isSystemEvent = (k: ActivityKind): boolean =>
  k === 'workspace.created' || k === 'invitation.expired';
      ...
      >
        ...
        <div class="z-10 shrink-0">
          <component
            ...
            class="size-[26px] rounded-full bg-muted p-1.5 text-muted-foreground ring-2 ring-card"
          />
          <UserPlus
            v-else-if="!entry.actor"
            class="size-[26px] rounded-full bg-muted p-1.5 text-muted-foreground ring-2 ring-card"
          />
          <div v-else class="rounded-full ring-2 ring-card">
            <AppAvatar
