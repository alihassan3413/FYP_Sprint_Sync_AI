...
const activeItemStyles = computed(() => (href: string) => (isCurrentRoute(href) ? 'text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100' : ''));
    ...
    <div>
        <div class="border-sidebar-border/80 border-b">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <Link :href="workspaceRoute('dashboard')" class="flex items-center gap-x-2">
