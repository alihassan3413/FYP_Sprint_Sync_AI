    ...
    <AuthBase>
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="text-center">
                <h1 class="text-2xl font-semibold tracking-tight">Join {{ invitation.workspace.name }}</h1>

                <p class="text-muted-foreground mt-2 text-sm">You have been invited to collaborate on SprintSync.</p>
            </div>
            ...
            <div class="grid gap-5">
                ...
                <Button type="submit" class="mt-1 w-full gap-2" tabindex="4" :disabled="form.processing">
