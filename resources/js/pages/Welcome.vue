...
<template>
  ...
  <div
    class="min-h-screen bg-[#fafaf7] font-sans text-black antialiased selection:bg-lime-500 selection:text-black"
  >
    <div class="overflow-hidden border-b-[3px] border-black bg-black text-white">
      <div
        class="animate-marquee flex py-2 text-sm font-bold tracking-widest whitespace-nowrap uppercase"
      >
    ...
    <header
      class="sticky top-0 z-40 border-b-[3px] border-black bg-[#fafaf7]/90 backdrop-blur"
    >
      <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-8">
        ...
        <div class="flex items-center gap-3">
          ...
          <template v-else>
            <Link
              :href="route('login')"
              class="hidden text-sm font-bold tracking-wider uppercase hover:underline sm:inline"
              >Log in</Link
            >
            <Link
              :href="route('register')"
    ...
    <section class="relative overflow-hidden border-b-[3px] border-black">
      ...
      <div class="relative mx-auto max-w-7xl px-4 py-16 md:px-8 md:py-24 lg:py-32">
        <div class="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div class="lg:col-span-7">
            ...
            >
              <span class="relative flex h-2 w-2">
                <span
                  class="absolute inline-flex h-full w-full animate-ping rounded-full bg-lime-500 opacity-75"
                ></span>
                <span
                  class="relative inline-flex h-2 w-2 rounded-full bg-lime-500"
                ></span>
              </span>
            ...
            >
              ...
              <span
                class="relative ml-2 inline-block -rotate-2 border-[3px] border-black bg-lime-500 px-3 shadow-[6px_6px_0_0_#000]"
              >
                ships.
              </span>
            </h1>
            ...
            <!-- Trust row -->
            <div
              class="mt-12 flex flex-wrap items-center gap-6 text-xs font-bold tracking-widest text-neutral-600 uppercase"
            >
              <span class="flex items-center gap-1.5"
                ><Check class="h-4 w-4" :stroke-width="3" /> 14-day free trial</span
              >
              <span class="flex items-center gap-1.5"
                ><Check class="h-4 w-4" :stroke-width="3" /> Self-hostable</span
              >
              <span class="flex items-center gap-1.5"
                ><Check class="h-4 w-4" :stroke-width="3" /> Open source core</span
              >
            </div>
          </div>
          ...
          <div class="lg:col-span-5">
            <div class="relative">
              ...
              <div
                class="absolute inset-0 translate-x-3 translate-y-3 border-[3px] border-black bg-pink-300"
              ></div>
              <div
                class="absolute inset-0 translate-x-1.5 translate-y-1.5 border-[3px] border-black bg-lime-500"
              ></div>

              <!-- Main "screenshot" card -->
              <div
                class="relative border-[3px] border-black bg-white p-5 shadow-[10px_10px_0_0_#000]"
              >
                <!-- Window chrome -->
                <div class="mb-4 flex items-center gap-2 border-b-2 border-black pb-3">
                  ...
                  <span class="ml-3 font-mono text-xs font-bold"
                ...
                <div class="grid grid-cols-3 gap-2">
                  <div class="space-y-2">
                    <div
                      class="border-2 border-black bg-neutral-100 px-2 py-1 text-[10px] font-bold uppercase"
                    >
                      To Do · 3
                    </div>
                    <div
                      class="border-2 border-black bg-white p-2 text-xs shadow-[2px_2px_0_0_#000]"
                    >
                  ...
                  <div class="space-y-2">
                    <div
                      class="border-2 border-black bg-yellow-200 px-2 py-1 text-[10px] font-bold uppercase"
                    >
                      Doing · 2
                    </div>
                    <div
                  ...
                  <div class="space-y-2">
                    <div
                      class="border-2 border-black bg-lime-500 px-2 py-1 text-[10px] font-bold uppercase"
                    >
                      Done · 8
                    </div>
                    <div
                ...
                <!-- AI assist popup -->
                <div
                  class="mt-4 flex items-start gap-2 border-[3px] border-black bg-yellow-200 p-3 shadow-[3px_3px_0_0_#000]"
                >
                  <div
                    class="flex h-8 w-8 shrink-0 items-center justify-center border-2 border-black bg-black"
                  >
                  ...
                  <div class="text-xs">
                    ...
                    <div class="mt-0.5 text-neutral-700">
                      Assigned to @ali, @sara · saved 12min
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- Stats row -->
        <div
          class="mt-20 grid gap-0 border-[3px] border-black bg-white shadow-[8px_8px_0_0_#000] sm:grid-cols-2 lg:grid-cols-4"
        >
          <div
            v-for="(s, i) in stats"
            :key="s.label"
          ...
          >
            ...
            <div
              class="mt-2 text-xs font-bold tracking-widest text-neutral-700 uppercase"
            >
              {{ s.label }}
            </div>
    ...
    <section class="border-b-[3px] border-black bg-black py-20 text-white md:py-28">
      <div class="mx-auto max-w-7xl px-4 md:px-8">
        <div class="max-w-3xl">
          ...
          <h2
            class="mt-6 text-4xl leading-[1.05] tracking-tight md:text-6xl"
            style="font-family: 'Archivo Black', sans-serif"
          >
        ...
        <div class="mt-16 grid gap-6 md:grid-cols-3">
          <!-- Jira card -->
          <div
            class="group border-[3px] border-white bg-neutral-900 p-7 transition-all hover:bg-red-950"
          >
            <div
              class="mb-5 inline-flex h-12 w-12 items-center justify-center border-[3px] border-white bg-red-500"
            >
            ...
            <p class="mt-3 text-sm font-bold tracking-wider text-red-300 uppercase">
          ...
          <!-- Linear card -->
          <div
            class="group border-[3px] border-white bg-neutral-900 p-7 transition-all hover:bg-yellow-950"
          >
            <div
              class="mb-5 inline-flex h-12 w-12 items-center justify-center border-[3px] border-white bg-yellow-400"
            >
            ...
            <p class="mt-3 text-sm font-bold tracking-wider text-yellow-300 uppercase">
              The dev-only club
            </p>
            <p class="mt-4 text-neutral-300">
              Fast — beautiful, even. But your PM bounces off the keyboard shortcuts, your
              designer can’t find the docs, and ops gets locked out. Tribal knowledge
              silos.
            </p>
          </div>
          ...
          <!-- ClickUp card -->
          <div
            class="group border-[3px] border-white bg-neutral-900 p-7 transition-all hover:bg-orange-950"
          >
            <div
              class="mb-5 inline-flex h-12 w-12 items-center justify-center border-[3px] border-white bg-orange-400"
            >
            ...
            <p class="mt-3 text-sm font-bold tracking-wider text-orange-300 uppercase">
              Feature graveyard
            </p>
            <p class="mt-4 text-neutral-300">
              17 view types, 40 custom field options, 12 automation triggers. Half are
              half-baked. New hires need three weeks to find anything. Slow on bad days.
            </p>
          </div>
        </div>
        ...
        <div class="relative mt-16">
          ...
          <div
            class="relative border-[3px] border-white bg-lime-500 p-8 text-black md:p-12"
          >
            <div class="flex items-start gap-6 md:items-center">
              <div
                class="flex h-16 w-16 shrink-0 items-center justify-center border-[3px] border-black bg-black md:h-20 md:w-20"
              >
              ...
              <div>
                ...
                <h3
                  class="mt-2 text-3xl tracking-tight md:text-5xl"
                  style="font-family: 'Archivo Black', sans-serif"
                >
        ...
        <div class="mt-16 grid gap-6 lg:grid-cols-12">
          <div class="lg:col-span-7">
            <div class="relative h-full">
              <div
                class="absolute inset-0 translate-x-2 translate-y-2 border-[3px] border-black bg-pink-300"
              ></div>
              <div
                class="relative h-full border-[3px] border-black bg-white p-8 shadow-[6px_6px_0_0_#000] md:p-10"
              >
                <div
                  class="flex h-14 w-14 items-center justify-center border-[3px] border-black bg-black"
                >
                  <Sparkles class="h-7 w-7 text-lime-500" :stroke-width="3" />
                </div>
                <h3
                  class="mt-6 text-3xl font-black tracking-tight md:text-4xl"
                  style="font-family: 'Archivo Black', sans-serif"
                >
                ...
                <p class="mt-4 text-neutral-700 md:text-lg">
                  ...
                  tags it, assigns it to the right engineer, and even drafts the first
                  reply.
                </p>
          ...
          <div class="lg:col-span-5">
            <div class="relative h-full">
              <div
                class="absolute inset-0 translate-x-2 translate-y-2 border-[3px] border-black bg-lime-500"
              ></div>
              <div
                class="relative flex h-full flex-col border-[3px] border-black bg-black p-8 text-white shadow-[6px_6px_0_0_#000] md:p-10"
              >
                <div
                  class="flex h-14 w-14 items-center justify-center border-[3px] border-white bg-lime-500"
                >
                ...
                <ul class="mt-6 space-y-3">
                  <li class="flex items-center gap-3 text-sm">
                    <Kanban class="h-5 w-5 text-lime-500" :stroke-width="3" /> Kanban +
                    Sprints
                  </li>
                  <li class="flex items-center gap-3 text-sm">
                    <FileText class="h-5 w-5 text-lime-500" :stroke-width="3" /> Docs &
                    Wiki
                  </li>
                  <li class="flex items-center gap-3 text-sm">
                  ...
                  <li class="flex items-center gap-3 text-sm">
                    <LineChart class="h-5 w-5 text-lime-500" :stroke-width="3" /> Roadmaps
                    & goals
                  </li>
                  <li class="flex items-center gap-3 text-sm">
          ...
          <div class="lg:col-span-4">
            <div class="relative h-full">
              <div
                class="absolute inset-0 translate-x-2 translate-y-2 border-[3px] border-black bg-cyan-300"
              ></div>
              <div
                class="relative flex h-full flex-col border-[3px] border-black bg-white p-7 shadow-[6px_6px_0_0_#000]"
              >
                <div
                  class="flex h-12 w-12 items-center justify-center border-[3px] border-black bg-cyan-300"
                >
                  <Server class="h-6 w-6" :stroke-width="3" />
                </div>
                <h3
                  class="mt-5 text-2xl font-black tracking-tight"
                  style="font-family: 'Archivo Black', sans-serif"
                >
                  Self-host. Sleep well.
                </h3>
                <p class="mt-3 text-sm text-neutral-700">
                  Docker compose, run it on your VPS or air-gapped. Your roadmap never
                  lives on someone else’s server.
                </p>
                <code
                  class="mt-5 block border-2 border-black bg-neutral-900 p-3 font-mono text-xs text-lime-500"
                >
          ...
          <div class="lg:col-span-4">
            <div class="relative h-full">
              <div
                class="absolute inset-0 translate-x-2 translate-y-2 border-[3px] border-black bg-yellow-300"
              ></div>
              <div
                class="relative flex h-full flex-col border-[3px] border-black bg-white p-7 shadow-[6px_6px_0_0_#000]"
              >
                <div
                  class="flex h-12 w-12 items-center justify-center border-[3px] border-black bg-yellow-300"
                >
                ...
                <p class="mt-3 text-sm text-neutral-700">
                  ...
                  <kbd
                    class="border-2 border-black bg-neutral-100 px-1 font-mono text-[10px] font-bold"
                    >⌘K</kbd
                  >. Mouse optional.
                </p>
                <div class="mt-5 flex flex-wrap gap-1.5">
                  <kbd
                    class="border-2 border-black bg-neutral-100 px-2 py-0.5 font-mono text-[10px] font-bold"
                    >⌘K</kbd
                  >
                  <kbd
                    class="border-2 border-black bg-neutral-100 px-2 py-0.5 font-mono text-[10px] font-bold"
          ...
          <div class="lg:col-span-4">
            <div class="relative h-full">
              <div
                class="absolute inset-0 translate-x-2 translate-y-2 border-[3px] border-black bg-orange-300"
              ></div>
              <div
                class="relative flex h-full flex-col border-[3px] border-black bg-white p-7 shadow-[6px_6px_0_0_#000]"
              >
                <div
                  class="flex h-12 w-12 items-center justify-center border-[3px] border-black bg-orange-300"
                >
    ...
    <section id="compare" class="border-b-[3px] border-black bg-primary/10 py-20 md:py-28">
      <div class="mx-auto max-w-7xl px-4 md:px-8">
        <div class="max-w-3xl">
          <div
            class="inline-flex items-center gap-2 border-[3px] border-black bg-white px-4 py-1.5 text-xs font-bold tracking-widest uppercase shadow-[3px_3px_0_0_#000]"
          ...
          <p class="mt-4 text-lg text-neutral-800">
            No marketing fluff. Here's how Sprint Sync stacks up against the big three.
          </p>
        </div>
            ...
            <table class="w-full text-left text-sm">
              <thead class="border-b-[3px] border-black bg-black text-white">
                <tr>
                  ...
                  <th
                    class="border-l-[3px] border-white bg-lime-500 p-4 font-black tracking-wider text-black uppercase md:p-5"
                  >
                    Sprint Sync
                  </th>
                  <th
                    class="border-l-[3px] border-white p-4 font-bold tracking-wider uppercase md:p-5"
                  >
                    Jira
                  </th>
                  <th
              ...
              <tbody>
                ...
                >
                  ...
                  <td
                    class="border-t-2 border-l-2 border-black bg-lime-100 p-4 font-bold md:p-5"
                  >
                    <span
        ...
        <div class="mt-16 grid gap-6 md:grid-cols-3">
          ...
          <div class="md:rotate-[-1deg]">
            <div class="relative">
              ...
              ></div>
              <div
                class="relative border-[3px] border-black bg-white p-6 shadow-[4px_4px_0_0_#000]"
              >
                ...
                <p class="text-base leading-relaxed font-semibold">
                  "Replaced Jira, Confluence, and Slack in our sprint loop. We close
                  standups 15 min faster and nobody complains about tools anymore."
                </p>
                <div class="mt-5 flex items-center gap-3 border-t-2 border-black pt-4">
                  <div
                    class="flex h-10 w-10 items-center justify-center border-2 border-black bg-pink-300 font-black"
                  >
                    M
                  </div>
                  <div>
                    <div class="text-sm font-black">Maya Chen</div>
                    <div class="text-xs tracking-wider text-neutral-600 uppercase">
          ...
          <div class="md:translate-y-4">
            <div class="relative">
              ...
              ></div>
              <div
                class="relative border-[3px] border-black bg-black p-6 text-white shadow-[4px_4px_0_0_#000]"
              >
                <div class="mb-3 flex gap-0.5">
                  <Star
                    v-for="n in 5"
                    :key="n"
                    class="h-4 w-4 fill-lime-300"
                    :stroke-width="0"
                  />
                </div>
                <p class="text-base leading-relaxed font-semibold">
                  "Self-hosted on a $20 VPS. Whole team uses it — devs, designers, our PM.
                  <span class="bg-lime-500 px-1 text-black">Finally</span>, a workspace
                  nobody hates."
                </p>
                <div class="mt-5 flex items-center gap-3 border-t-2 border-white pt-4">
                  <div
                    class="flex h-10 w-10 items-center justify-center border-2 border-white bg-lime-500 font-black text-black"
                  >
                    D
                  </div>
                  <div>
          ...
          <div class="md:rotate-[1deg]">
            <div class="relative">
              ...
              >
                ...
                <div class="mt-5 flex items-center gap-3 border-t-2 border-black pt-4">
                  <div
                    class="flex h-10 w-10 items-center justify-center border-2 border-black bg-yellow-300 font-black"
                  >
                    A
                  </div>
                  <div>
    ...
    <section id="pricing" class="border-b-[3px] border-black bg-lime-100 py-20 md:py-28">
      <div class="mx-auto max-w-7xl px-4 md:px-8">
        <div class="text-center">
          ...
          <!-- Billing toggle -->
          <div
            class="mt-10 inline-flex border-[3px] border-black bg-white shadow-[4px_4px_0_0_#000]"
          >
            <button
          ...
          >
            ...
            >
              ...
              <ul class="mt-6 space-y-2.5 border-t-2 border-black pt-6">
                ...
                >
                  <div
                    class="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center border-2 border-black bg-black"
                  >
              ...
              <Link
                ...
                :class="
                  t.highlighted ? 'bg-black text-lime-500' : 'bg-lime-500 text-black'
                "
              >
                {{ t.cta }}
      ...
      <div class="mx-auto max-w-4xl px-4 md:px-8">
        ...
        <div class="mt-12 space-y-4">
          <div v-for="(item, i) in faqs" :key="i" class="relative">
            <div
              class="absolute inset-0 translate-x-1.5 translate-y-1.5 border-[3px] border-black bg-black"
            ></div>
            <div class="relative border-[3px] border-black bg-white">
              ...
              >
                ...
                <div
                  ...
                  :class="
                    openFaq === i ? 'bg-black text-lime-500' : 'bg-lime-500 text-black'
                  "
                >
              ...
              <div
                v-if="openFaq === i"
                class="border-t-2 border-black bg-neutral-50 p-5 text-sm text-neutral-700 md:p-6 md:text-base"
              >
                {{ item.a }}
              </div>
            </div>
    ...
    <section
      class="relative overflow-hidden border-b-[3px] border-black bg-lime-500 py-20 md:py-28"
    >
      ...
      <div class="relative mx-auto max-w-5xl px-4 text-center md:px-8">
        <h2
          class="text-5xl leading-[0.95] tracking-tight md:text-7xl lg:text-8xl"
          style="font-family: 'Archivo Black', sans-serif"
        >
          Ship the
          <span
            class="inline-block -rotate-1 bg-black px-3 text-lime-500 shadow-[6px_6px_0_0_#000]"
            >damn thing.</span
          >
        </h2>
        <p class="mx-auto mt-8 max-w-2xl text-lg text-neutral-800 md:text-xl">
          Stop fighting your tools. Start shipping. 14-day free trial, no credit card, no
          sales call.
        </p>
      ...
      <div class="mx-auto max-w-7xl px-4 md:px-8">
        <div class="grid gap-12 md:grid-cols-4">
          <div class="md:col-span-2">
            <div class="flex items-center gap-3">
              <div
                class="flex h-10 w-10 items-center justify-center border-[3px] border-lime-500 bg-lime-500"
              >
            ...
            <p class="mt-5 max-w-md text-sm text-neutral-400">
              ...
              configure. Self-hostable. AI-powered. Loved.
            </p>
          </div>
          <div>
            <h4 class="text-sm font-black tracking-widest text-lime-500 uppercase">
              Product
            </h4>
        ...
        <div
          class="mt-12 flex flex-col items-start justify-between gap-4 border-t-2 border-neutral-800 pt-8 md:flex-row md:items-center"
        >
          <p class="text-xs text-neutral-500">
            © 2026 Sprint Sync. Built with rage against bad tools.
          </p>
          <div class="flex gap-2">
            <a
              href="#"
              class="border-2 border-neutral-700 p-2 transition-colors hover:border-lime-500 hover:text-lime-500"
            >
