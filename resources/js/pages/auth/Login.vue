...
<template>
    <AuthBase title="Welcome back" description="Sign in to continue to Sprint Sync">
        ...
        <div class="space-y-5">
            <div v-if="status" class="bg-primary flex items-center gap-2 border-[1.5px] border-black px-4 py-2.5 text-sm font-semibold text-black">
            ...
            <form @submit.prevent="submit" class="space-y-3.5">
                ...
                <div class="flex items-center gap-2.5 pt-0.5">
                    <Checkbox id="remember" v-model:checked="form.remember" tabindex="3" class="border-[1.5px] border-black" />
                    <Label for="remember" class="cursor-pointer text-sm font-normal text-zinc-700"> Remember me for 30 days </Label>
                </div>
            ...
            <p class="text-sm text-zinc-500">
                ...
                <Link
                    :href="route('register')"
                    :tabindex="5"
                    class="before:bg-primary relative isolate ml-0.5 inline-block cursor-pointer px-1.5 py-0.5 font-semibold text-black no-underline before:absolute before:inset-0 before:-z-10 before:-skew-x-6 before:opacity-0 before:transition-opacity hover:before:opacity-100"
                >
                    Create one free
                </Link>
            </p>
